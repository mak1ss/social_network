...
import com.practice.social_network.dtos.authorization.AuthorizationRequest;
...
import com.practice.social_network.services.AuthorizationService;
import com.practice.social_network.services.TokenService;
...
public class AuthorizationController {
    ...
    @PostMapping("/refresh")
    public ResponseEntity<AuthorizationResponse> refresh(@RequestBody String refreshToken) {
